...
from servers.flask.apps.app import db  # p185 추가
from servers.flask.apps.crud.models import User  # p185 추가

# UploadImageForm을 import 한다
from servers.flask.apps.detector.forms import UploadImageForm  # p211 추가 업로드 이미지 객체
from servers.flask.apps.detector.forms import DeleteForm, DetectorForm  # / p235 추가 / p229 추가

#                                 p185            p227
from servers.flask.apps.detector.models import UserImage, UserImageTag
...
def search():
    ...
    # user_images를 반목하여 user_images에 연결된 정보를 검색한다.
    for user_image in user_images:
        ...
        # user_image_id를 킬로 하는 사전에 캐그 정보를 설정한다.
        user_image_tag_dict[user_image.UserImage.id] = user_image_tags
